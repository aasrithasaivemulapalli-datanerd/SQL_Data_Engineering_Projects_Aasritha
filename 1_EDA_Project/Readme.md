...
4. [`04_Company_data_engineer_jobs.sql`](04_Company_data_engineer_jobs.sql) - Gives the top 10 companies who have posted the highest number of data engineer jobs
5. [`05_job_postings_other_countries.sql`](05_job_postings_other_countries.sql) - Queries top 10 companies that have posted Data Engineer jobs in more than one country.
